...
cdef class Ship:
    cdef :
        public Armada game
        public int team, faction, max_hull, point, command_value, engineer_value, squad_value, id, speed, hull, engineer_budget, engineer_spent, attack_count
        ...
        public tuple base_size, token_size, shield, defense_tokens, command_stack, command_dial, command_token, resolved_command, attack_history, repaired_hull, reduced_hull, anti_squad
