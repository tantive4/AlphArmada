...
from armada_game.helpers.enum_class import ObstacleType
from armada_game.helpers.measurement import STATION, DEBRIS1, DEBRIS2, ASTEROID1, ASTEROID2, ASTEROID3
