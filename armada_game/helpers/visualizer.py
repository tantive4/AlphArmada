...
from armada_game.helpers.measurement import SQUAD_BASE_RADIUS
from armada_game.helpers.paths import asset_path
if TYPE_CHECKING:
...
def visualize(game : "Armada", title : str,  maneuver_tool : list[tuple[float, float]] | None = None) -> None:
    ...
    font = ImageFont.truetype(str(asset_path("ARIAL.TTF")), 18)
    font_small = ImageFont.truetype(str(asset_path("ARIAL.TTF")), 10)
